...
export class DissertationsComponent extends BaseComponent implements OnInit {
  ...
  public async deleteRecord() {
    ...
    if (result) {
      try {
        await lastValueFrom(this.departmentService.deleteDissertation(this.selectedRecord.id));
  ...
  private async getDissertations() {
    try {
      this.records = await lastValueFrom(this.departmentService.getDepartmentDissertations());
